...
part of 'reviews_remote_data_source.dart';
...
class _ReviewsRemoteDataSource implements ReviewsRemoteDataSource {
  _ReviewsRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<ReviewsResponse> getProductReviews(String productId) async {
